...
const Page = ({ params }) => {
  ...
  return (
    <div>
      {/* <!-- component --> */}
      <section class="text-gray-700 body-font overflow-hidden  scroll-hidden">
        {/* {products.map((product, key) => ( */}
        <div class="container px-5 py-10 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap bg-white py-5 px-5   shadow-lg shadow-blue-100 ">
            <img alt="ecommerce" class=" w-80 max-h-96 object-cover object-center object-fill "  src={products.image} />
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  {/* {products.rating.map((product,key)=>( */}
